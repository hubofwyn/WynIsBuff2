...
export class WallDashController {
    constructor(scene, eventSystem) {
        ...
        this.wallParams = {
            ...
            wallDash: {
                ...
                angleOptions: [         // Available dash angles
                    { x: 1, y: 0 },     // Horizontal
     ...
     */
    canDash() {
        return this.dashState.available && 
    ...
    initiateDash(body, input, velocity) {
        ...
        let dashDir = this.calculateDashDirection(input, velocity);
     ...
     */
    canWallJump() {
        return this.wallState.slideActive || 
               (this.wallState.touchingLeft || this.wallState.touchingRight);
    }
