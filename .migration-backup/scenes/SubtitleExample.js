...
export class SubtitleExample extends Scene {
    ...
    create() {
        ...
        // Title
        this.add.text(400, 100, 'Subtitle System Example', {
            fontSize: '32px',
            color: '#ffffff'
        }).setOrigin(0.5);
        
        // Instructions
        this.add.text(400, 200, 'Click buttons to test subtitle system', {
            fontSize: '20px',
            color: '#cccccc'
        }).setOrigin(0.5);
        
        // Toggle subtitles button
        const toggleBtn = this.add.text(400, 300, `Subtitles: ${subtitlesEnabled ? 'ON' : 'OFF'}`, {
            fontSize: '24px',
            color: '#00ff00',
