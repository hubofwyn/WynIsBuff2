...
- **Satisfying Feedback**: Audio, visual responses to player actions
...
- Flow preservation: minimize interruptions

## Creative Process

1. Understand player goals
2. Identify pain points in current gameplay
3. Brainstorm multiple creative approaches
4. Prototype rapidly within existing architecture
5. Iterate based on feedback
6. Integrate holistically with existing systems

Always prioritize player enjoyment while respecting the skill-to-automation core loop.
