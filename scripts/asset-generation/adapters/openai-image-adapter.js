...
const PRICING = {
  'standard-1024': 0.040,   // $0.040 per image (1024x1024 standard)
  'standard-1792': 0.080,   // $0.080 per image (1024x1792 or 1792x1024 standard)
  'hd-1024': 0.080,         // $0.080 per image (1024x1024 HD)
  'hd-1792': 0.120          // $0.120 per image (1024x1792 or 1792x1024 HD)
};
...
export class BudgetGuard {
  ...
  charge(cost, reason) {
    ...
    if (this.spent > this.dailyLimit) {
      ...
      throw new Error(`Budget exceeded: $${this.spent.toFixed(2)} > $${this.dailyLimit.toFixed(2)}`);
    }
