...
export class FactoryScene extends Scene {
    ...
    createBackground() {
        ...
        this.add.rectangle(0, 0, this.scale.width, this.scale.height, 0x2c3e50).setOrigin(0, 0);
    ...
    createFactoryLayout() {
        // Title
        this.add
            .text(this.scale.width / 2, 30, 'BUFF FACTORY', {
                fontSize: '42px',
        ...
        // Subtitle
        this.add
            .text(this.scale.width / 2, 70, 'Automated Production Facility', {
                fontSize: '18px',
                fontFamily: 'Arial',
                color: '#95a5a6',
            })
    ...
    createProductionLineFromLane(index, x, y, laneData) {
        ...
        const bg = this.add
            .rectangle(x, y, 600, 80, 0x27ae60, 0.3)
            .setOrigin(0, 0.5)
        ...
        const rateText = this.add.text(
            ...
            `${laneData.effectiveRate.toFixed(1)}/s (${laneData.decayPercent.toFixed(0)}% efficiency)`,
            {
                ...
                fontFamily: 'Arial',
                color:
                    laneData.decayPercent > 80
                        ? '#27ae60'
                        : laneData.decayPercent > 60
                          ? '#f39c12'
                          : '#e74c3c',
            }
        );
        ...
        // Decay bar
        const _decayBarBg = this.add.rectangle(x + 350, y, 200, 20, 0x7f8c8d, 0.3).setOrigin(0, 0.5);
        const decayBarFill = this.add
            .rectangle(
                x + 350,
                y,
                200 * (laneData.decayPercent / 100),
                20,
                laneData.decayPercent > 80
                    ? 0x27ae60
                    : laneData.decayPercent > 60
    ...
    createProductionLine(index, x, y) {
        ...
        this.add
            .rectangle(progressX, y, progressBarWidth, progressBarHeight, 0x000000, 0.5)
            .setOrigin(0, 0.5);

        // Progress bar fill
        const progressFill = this.add
            .rectangle(progressX, y, 0, progressBarHeight, 0x27ae60)
            .setOrigin(0, 0.5);

        // Upgrade button
        const upgradeButton = this.add
            .text(x + 520, y, '[UPGRADE]', {
                fontSize: '14px',
                fontFamily: 'Arial Black',
                color: '#00FF00',
    ...
    createLockedLine(index, x, y) {
        ...
        const bg = this.add
            .rectangle(x, y, 600, 80, 0x7f8c8d, 0.2)
            .setOrigin(0, 0.5)
        ...
        this.add
            .text(x + 300, y, `Unlock: ${this.formatNumber(unlockCost)} Buff Coins`, {
                fontSize: '16px',
                fontFamily: 'Arial',
                color: '#95a5a6',
            })
    ...
    createControlPanel() {
        ...
        // Panel background
        this.add
            .rectangle(panelX, panelY, panelWidth, panelHeight, 0x34495e, 0.8)
            .setOrigin(0.5, 0)
            .setStrokeStyle(2, 0x95a5a6);

        // Panel title
        this.add
            .text(panelX, panelY + 20, 'CONTROL PANEL', {
                fontSize: '18px',
                fontFamily: 'Arial Black',
                color: '#FFFFFF',
            })
        ...
        // Production stats
        this.totalProductionText = this.add
            .text(panelX, panelY + 60, 'Total Production:\n0/sec', {
                fontSize: '14px',
                fontFamily: 'Arial',
                color: '#FFFFFF',
                align: 'center',
        ...
        // Efficiency
        this.efficiencyText = this.add
            .text(panelX, panelY + 110, 'Efficiency: 100%', {
                fontSize: '14px',
                fontFamily: 'Arial',
                color: '#27ae60',
            })
        ...
        // Boost button
        this.boostButton = this.add
            .text(panelX, panelY + 160, '[BOOST x2]', {
                fontSize: '16px',
                fontFamily: 'Arial Black',
                color: '#FFD700',
                backgroundColor: '#000000',
        ...
        this.collectButton = this.add
            .text(panelX, panelY + 210, '[COLLECT ALL]', {
                fontSize: '16px',
                fontFamily: 'Arial Black',
                color: '#00FF00',
                backgroundColor: '#000000',
        ...
        // Auto-collect toggle
        this.autoCollectText = this.add
            .text(panelX, panelY + 260, '⬜ Auto-Collect', {
                fontSize: '14px',
                fontFamily: 'Arial',
                color: '#FFFFFF',
            })
    ...
    createResourceDisplay() {
        ...
        // Buff Coins
        this.resourceTexts.buffCoins = this.add
            .text(panelX, panelY, `🪙 ${this.formatNumber(resources.buffCoins || 0)}`, {
                fontSize: '18px',
                fontFamily: 'Arial',
                color: '#FFD700',
            })
        ...
        // Buff Gems
        this.resourceTexts.buffGems = this.add
            .text(panelX, panelY + 25, `💎 ${this.formatNumber(resources.buffGems || 0)}`, {
                fontSize: '18px',
                fontFamily: 'Arial',
                color: '#FF69B4',
            })
    ...
    createNavigationButtons() {
        ...
        // Back to Hub button
        this.createNavButton(centerX, buttonY, 'BACK TO HUB', 0x0080ff, () => this.returnToHub());
    }

    createNavButton(x, y, text, color, callback) {
        const button = this.add
            .rectangle(x, y, 150, 40, color)
            .setInteractive({ useHandCursor: true })
            .on('pointerover', () => {
                button.setScale(1.1);
            })
    ...
    collectAllProduction() {
        const totalCollected = { buffCoins: 0, buffGems: 0 };
    ...
    showInsufficientFunds() {
        const text = this.add
            .text(this.scale.width / 2, this.scale.height / 2, 'Insufficient Buff Coins!', {
                fontSize: '24px',
                fontFamily: 'Arial Black',
                color: '#FF0000',
                stroke: '#000000',
