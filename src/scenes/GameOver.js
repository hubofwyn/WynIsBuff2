...
export class GameOver extends Scene {
    ...
    createDramaticGameOver() {
        ...
        // Explosion message
        const explosionText = this.add.text(512, 450, 'YOU EXPLODED!!!', {
        ...
        // Warning message
        const warningText = this.add.text(512, 550, 'NEVER ATTEMPT A FOURTH JUMP DURING COOLDOWN!', {
            fontFamily: 'Arial',
            fontSize: '24px',
            color: '#ffffff',
            stroke: '#000000',
        ...
        this.time.addEvent({
            ...
            callback: () => {
                ...
                const particle = this.add.circle(x, y, Phaser.Math.Between(5, 20), 
    ...
    createDramaticButtons() {
        ...
        const tryAgainButton = this.add.text(512, 650, 'TRY AGAIN (IF YOU DARE)', {
            fontFamily: 'Arial Black',
            fontSize: '32px',
            color: '#ff0000',
            stroke: '#ffffff',
            strokeThickness: 4
        }).setOrigin(0.5).setInteractive().setScale(0);
        ...
        // Main menu button
        const menuButton = this.add.text(512, 720, 'FLEE TO MAIN MENU', {
            fontFamily: 'Arial',
            fontSize: '24px',
            color: '#ffffff',
            stroke: '#000000',
