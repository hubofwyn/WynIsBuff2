...
export class WelcomeScene extends Scene {
    ...
    create() {
        ...
        const mainTitle = this.add
            .text(width / 2, height * 0.25, 'WYN IS BUFF 2', {
        ...
        const subtitle = this.add
            .text(width / 2, height * 0.35, 'SKILL TO AUTOMATION', {
        ...
        const promptText = this.add
            .text(width / 2, height * 0.65, 'CLICK TO START YOUR TRAINING', {
                fontFamily: 'Arial, sans-serif',
                fontSize: '24px',
                color: '#FFFFFF',
                stroke: '#000000',
        ...
        const contextText = this.add
            .text(width / 2, height * 0.75, 'Transform your skills into unstoppable automation', {
                fontFamily: 'Arial, sans-serif',
                fontSize: '18px',
                color: '#CCCCCC',
                fontStyle: 'italic',
