...
export class HubScene extends Scene {
    ...
    createHubLayout() {
        ...
        // Hub title
        this.add.text(centerX, 50, 'BUFF CENTRAL HUB', {
            fontSize: '48px',
        ...
        this.welcomeText = this.add.text(centerX, 100, welcomeText, {
            fontSize: '20px',
            fontFamily: 'Arial',
            color: '#FFFFFF',
            align: 'center'
    ...
    createResourceDisplay() {
        ...
        this.buffCoinsText = this.add.text(panelX + 10, panelY + 20, 
        ...
        this.buffGemsText = this.add.text(panelX + 10, panelY + 50, 
        ...
        this.dnaText = this.add.text(panelX + 10, panelY + 80, 
        ...
        this.timeEchoesText = this.add.text(panelX + 10, panelY + 110, 
    ...
    createIdleProgressDisplay() {
        ...
        this.add.rectangle(centerX, progressY, panelWidth, panelHeight, 0x000000, 0.7)
            .setOrigin(0.5)
            .setStrokeStyle(2, 0x00FF00);
        
        // Title
        this.add.text(centerX, progressY - 80, 'IDLE PROGRESS', {
            fontSize: '24px',
            fontFamily: 'Arial Black',
            color: '#00FF00'
        }).setOrigin(0.5);
        ...
        // Progress indicators
        this.idleProgressText = this.add.text(centerX, progressY - 30, 
        ...
        this.automationText = this.add.text(centerX, progressY, 
        ...
        // Production rate
        this.productionRateText = this.add.text(centerX, progressY + 30, 
            'Production Rate: 0/sec', {
            fontSize: '16px',
            fontFamily: 'Arial',
            color: '#FFD700'
        }).setOrigin(0.5);
        ...
        this.milestoneText = this.add.text(centerX, progressY + 60, 
            'Next Milestone: --:--', {
            fontSize: '16px',
            fontFamily: 'Arial',
            color: '#FF69B4'
    ...
    showOfflineProgressPopup(seconds) {
        ...
        const popup = this.add.rectangle(centerX, centerY, 400, 300, 0x000000, 0.9)
            .setStrokeStyle(3, 0xFFD700);
        
        // Title
        const title = this.add.text(centerX, centerY - 100, 'OFFLINE PROGRESS', {
            fontSize: '24px',
            fontFamily: 'Arial Black',
            color: '#FFD700'
        }).setOrigin(0.5);
        ...
        const timeAway = this.add.text(centerX, centerY - 50, 
            `You were away for: ${timeText}`, {
            fontSize: '16px',
            fontFamily: 'Arial',
            color: '#FFFFFF'
        }).setOrigin(0.5);
        ...
        const rewards = this.add.text(centerX, centerY, 
            'Calculating rewards...', {
            fontSize: '16px',
            fontFamily: 'Arial',
            color: '#00FF00',
        ...
        // Close button
        const closeButton = this.add.text(centerX, centerY + 100, '[COLLECT]', {
            fontSize: '20px',
            fontFamily: 'Arial Black',
            color: '#00FF00',
