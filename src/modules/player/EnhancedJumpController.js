...
export class EnhancedJumpController {
    ...
    updateGroundState(isGrounded, now, velocityY) {
        ...
        const effectivelyGrounded =
            isGrounded || (velocityY > 0 && this.predictGroundContact(velocityY));
    ...
    executeJump(body, sprite, currentVelocity, now) {
        ...
        const jumpVelocity = curve.initialVelocity * timingBonus;
    ...
    getJumpCurve(jumpNumber) {
        switch (jumpNumber) {
            case 1:
                return this.jumpCurves.base;
            case 2:
                return this.jumpCurves.double;
            case 3:
                return this.jumpCurves.triple;
            default:
                return this.jumpCurves.base;
        }
    }
