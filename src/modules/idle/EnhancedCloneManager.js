...
export class EnhancedCloneManager extends CloneManager {
    ...
    applyDecayToLane(laneId) {
        ...
        if (hoursSinceLastUpdate > 0) {
            ...
            if (this.debug && hoursSinceLastUpdate > 0.1) {
                ...
                LOG.dev('ENHANCEDCLONEMANAGER_LANE_DECAYED', {
                    ...
                    decayPercentage: parseFloat(
                        ((1 - lane.currentRate / lane.baseRate) * 100).toFixed(1)
                    ),
                });
            }
        }
    ...
    deserialize(state) {
        ...
        if (this.lastUpdateTime < Date.now() - 60000) {
